...
extern const MIDL_SERVER_INFO MyRPCProject_ServerInfo;

extern const RPC_DISPATCH_TABLE MyRPCProject_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE MyRPCProject___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x906e0ce0,0xadde,0x4733,{0x93,0xe2,0x30,0xd6,0x35,0xf9,0x99,0x96}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&MyRPCProject_v1_0_DispatchTable,
    0,
    0,
    0,
    &MyRPCProject_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE MyRPCProject_v1_0_s_ifspec = (RPC_IF_HANDLE)& MyRPCProject___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const MIDL_STUB_DESC MyRPCProject_StubDesc = 
    {
    (void *)& MyRPCProject___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION MyRPCProject_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE MyRPCProject_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)MyRPCProject_table
    };

static const SERVER_ROUTINE MyRPCProject_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)HelloProc,
    (SERVER_ROUTINE)Shutdown
    };

static const MIDL_SERVER_INFO MyRPCProject_ServerInfo = 
    {
    &MyRPCProject_StubDesc,
    MyRPCProject_ServerRoutineTable,
    MyRPCProject__MIDL_ProcFormatString.Format,
    MyRPCProject_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
